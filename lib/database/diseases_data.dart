...
List<String> diseaseSuggestions = [
  'Hemophilia',
  'A, Hemophilia',
  'Hemophilia A',
  'Hepatitis A',
  ...
  'Scrapes and Puncture Wounds Cuts',
  'Abrasion',
  ...
  'Blepharospasm',
  'Botox Treatment',
  'Blepharospasm Treatment, Botox',
  'Botox Blepharospasm Treatment',
  'Blindness',
  'Blindness, Face',
  'Bloated Stomach',
  'Bloating',
  ...
  'Colostomy Bowel Diversion Surgery Ileostomy',
  'Cauliflower Ear',
  'Boxer\'s Ear',
  'BPD',
  'BPH',
  ...
  'Cosmetic Surgery, Chemical Peel',
  'Chemical Peel Cosmetic Surgery',
  'Cosmetic Surgery, Collagen Injections',
  'Collagen Injections Cosmetic Surgery',
  'Dermabrasion',
  'Cosmetic Surgery, Dermabrasion',
  'Dermabrasion Cosmetic Surgery',
  'Cosmetic Surgery, Lip Augmentation',
  'Lip Augmentation Cosmetic Surgery',
  'Liposuction',
  ...
  'Crohn Disease, Intestinal Problems',
  ...
  'Diet, Diabetes',
  'IBS',
  'Irritable Bowel Syndrome  Triggers, Prevention',
  'Prevention Irritable Bowel Syndrome  Triggers',
  'Diet, IBS',
  'IBS Diet',
  ...
  'Healthy Living',
  'Disease Prevention, Health Living',
  'Health Living Disease Prevention',
  'Disease, Alzheimer\'s',
  'Alzheimer\'s Disease',
  'Disease, Behcet\'s',
  'Behcet\'s Disease',
  ...
  'Sleep in Children Disorders',
  'Disorders, Sleep in Teenagers',
  'Sleep in Teenagers Disorders',
  'Dissection, Aorta',
  'Aorta Dissection',
  'Dissociative Identity Disorder',
  'Distal Monosomy 1p36',
  'Disturbed Nocturnal Sleep',
  'Diversion Surgery, Bowel',
  ...
  'Guinea Worm Disease',
  'Dracunculiasis',
  'Drainage Bags for Incontinence',
  ...
  'Vitamins & Exercise',
  'Exercise and Vitamins for Heart Attack Prevention',
  ...
  'External Catheters for Incontinence',
  'External Otitis',
  'Extratemporal Cortical Resection',
  'Extreme Cold Exposure',
  'Extreme Homesickness in Children',
  'Extreme Water Loss',
  'Eye Bruise',
  'Eye Care',
  'Eye Floaters',
  ...
  'Flu Complications for Health Compromised People',
  'Flu in People With Health Risks',
  ...
  'Functioning Adenoma',
  'Fungal Arthritis',
  'Fungal Infections: Breastfeeding',
  'Fungal Meningitis',
  'Fusion, Lumbar',
  'Lumbar Fusion',
  'G6PD Deficiency',
  ...
  'Gain Weight and Quitting Smoking',
  'Gallbladder Scan',
  'Gallbladder x-ray',
  ...
  'Gastric Ulcer',
  'Gastritis',
  'Gastroesophageal Reflux Disease Test',
  'Gastroparesis',
  'Gastroscopy',
  'Gaucher\'s Disease',
  'GD',
  ...
  'Heart Attack Prevention: Exercise and Vitamins',
  ...
  'Stool Acidity Test',
  'Lactose Tolerance Test for Infants',
  'Lamaz Technique for Childbirth',
  'Lambliasis',
  'Lambliosis',
  ...
  'Low Birth Weight and Breastfeeding',
  'Low Blood Glucose',
  'Low Blood Sugar',
  'Low Cell Volume',
  ...
  'Memory Loss',
  'Men\'s Sexual Health',
  'Men, Disease Prevention',
  'Disease Prevention Men',
  'Men, Health Screening for Men',
  'Health Screening for Men Men',
  'Men, Night Sweats',
  'Night Sweats Men',
  'Meningeal Tumors',
  'Meningioma',
  ...
  'Monilia Infection, Children',
  'Children Monilia Infection',
  'Monitoring, Esophageal pH Test',
  'Esophageal pH Test Monitoring',
  'Monkeypox',
  'Mono',
  'Mononucleosis',
  ...
  'MPV',
  'Multiple Sclerosis',
  'MS, Alternative and Complementary Therapies',
  ...
  'Neuropathy',
  'Neuropathy, Autonomic Diabetic',
  'Autonomic Diabetic Neuropathy',
  'Neuropathy, Diabetic',
  'Neuropathy, Diabetic Peripheral',
  'Neuropathy, Focal Diabetic',
  'Focal Diabetic Neuropathy',
  'Neuropathy, Peripheral',
  'Neuropathy, Proximal  Diabetic',
  ...
  'Osteosarcoma',
  'OT for Arthritis',
  'OTC Asthma Treatments',
  'OTC Drugs for Constipation',
  'OTC Medication and Pregnancy',
  ...
  'Overheating',
  'Overload, Iron',
  'Oversupply of Milk: Breastfeeding',
  'Overuse Syndrome',
  'Overweight',
  'Ovulation Indicator Testing Kits',
  'Ovulation Method to Conceive',
  'Oximetry',
  'Pacemaker',
  'PACs',
  'PAD',
  ...
  'Pancreas, Mucinous Cyst Adenomas',
  'Mucinous Cyst Adenomas Pancreas',
  'Pancreas, Non-Inflammatory Cysts',
  ...
  'Pap Test',
  'Papillary Carcinoma',
  'Papillomavirus, Human Test',
  'Human Test Papillomavirus',
  ...
  'Pharmacologic Stress Test For Heart Disease',
  'Pharyngitis',
  'Sore Throat',
  ...
  'Plasmapheresis',
  'Plastic Surgery, Collagen Injections',
  'Collagen Injections Plastic Surgery',
  ...
  'Prevention, Atherosclerosis & Heart Attack',
  'Atherosclerosis & Heart Attack Prevention',
  'Prevention, Heart Attack & Atherosclerosis',
  'Heart Attack & Atherosclerosis Prevention',
  'Prevention, IBS',
  ...
  'Proctitis',
  'Products for Incontinence in Men',
  'Profunda, Miliaria',
  'Progeria',
  ...
  'Rehabilitation for Broken Back',
  'Rehabilitation for Cervical Fracture',
  'Rehabilitation for Lumbar Fracture',
  ...
  'Segawa\'s Dystonia',
  'Seizure First Aid',
  'Seizure Surgery, Children',
  'Children Seizure Surgery',
  'Seizure Test',
  'Seizure, Febrile',
  'Febrile Seizure',
  ...
  'Sleep Aids',
  'Sleep Disorder',
  'Sleep Disorder, Periodic Limb Movement',
  ...
  'Sodium',
  'Sodium, Low Levels in the Blood',
  'Low Levels in the Blood Sodium',
  'Solar Keratosis',
  'Sole Sweating, Excessive',
  ...
  'Spigelian Hernia',
  'Spinal Epidural for Childbirth',
  ...
  'Stool Test, Acid',
  'Acid Stool Test',
  'Strabismus Treatment, Botox',
  'Botox Strabismus Treatment',
  'Strain, Neck',
  'Strained Voice',
  'Strawberry',
  'Strawberry Tongue',
  ...
  'GAS',
  'Strep Throat',
  'Strep Throat Infection Test',
  'Streptococcus, Group A Test',
  'Group A Test Streptococcus',
  'Stress',
  ...
  'Stress Throat Test, Rapid',
  'Rapid Stress Throat Test',
  'Stress, Breast Cancer',
  'Breast Cancer Stress',
  'Stretch Marks',
  'Strictures, Esophagus',
  ...
  'Test, Ferritin',
  'Ferritin Test',
  'Test, Gastroesophageal Reflux Disease',
  'Test, GERD',
  'Test, Homocysteine',
  'Homocysteine Test',
  'Test, HPV',
  ...
  'Tests During Third Trimester of Pregnancy',
  'Tests for Diabetes',
  'Tests, Pregnancy',
  'Pregnancy Tests',
  'Tests, Prenatal',
  ...
  'Toenails, Ingrown',
  'Ingrown Toenails',
  'Toilet Substitutes for Incontinence',
  ...
  'UI',
  'Ulcer',
  'Ulcerative Colitis, Intestinal Problems',
  ...
  'Underactive Thyroid',
  'Underage Drinking',
  'Underarm Sweating, Excessive',
  'Excessive Underarm Sweating',
  'Underpads for Incontinence',
  ...
  'X-ray Esophagus, Stomach, Duodenum',
